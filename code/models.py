...
class SLMGAE_BC():
    ...
    def build(self):
        ...
        self.hid6 = GraphConvolution(
            name='gcn_dense_layer6',
            input_dim=FLAGS.hidden1,
            output_dim=FLAGS.hidden2,
            adj=self.adjs[5],
            act=tf.nn.leaky_relu,
        ...
        self.main_rec = wInnerProductDecoder(
                name='gcn_decoder',
                output_dim=FLAGS.hidden2,
